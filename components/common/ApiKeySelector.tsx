...
export const ApiKeySelector: React.FC<ApiKeySelectorProps> = ({ onKeySelected }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center p-8 bg-zinc-800/50 rounded-lg border border-zinc-700">
            ...
            <button
                ...
                className="bg-indigo-600 text-white font-bold py-2 px-6 rounded-lg hover:bg-indigo-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-indigo-500"
            >
                Select API Key
            </button>
        </div>
